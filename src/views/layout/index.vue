  ...
  <div class="common-layout">
    <el-container>
      ...
      <el-header class="header">
        <span class="title">霓虹信息管理系统</span>
      ...
      <el-container>
        ...
        <el-aside width="200px" class="aside">
          ...
          <el-menu router>
            ...
            <!-- 系统信息管理 -->
            <el-sub-menu index="/admin/system" v-if="job==4||job==3">
              <template #title>
            ...
            <el-sub-menu index="/admin/report">
              ...
              <el-menu-item index="/admin/report/emp">
                <el-icon><InfoFilled /></el-icon>员工信息统计
              </el-menu-item>
              <el-menu-item index="/admin/report/stu">
